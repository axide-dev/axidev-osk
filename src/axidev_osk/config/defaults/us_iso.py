...
def build_us_iso_layout(*, target_window_id: str = "window:keyboard") -> list[KeySpec]:
    ...
    return [
        ...
        key("F1", row=0, column=u(2), io_key="F1"),
        key("F2", row=0, column=u(3), io_key="F2"),
        key("F3", row=0, column=u(4), io_key="F3"),
        key("F4", row=0, column=u(5), io_key="F4"),
        key("F5", row=0, column=u(7), io_key="F5"),
        key("F6", row=0, column=u(8), io_key="F6"),
        key("F7", row=0, column=u(9), io_key="F7"),
        key("F8", row=0, column=u(10), io_key="F8"),
        key("F9", row=0, column=u(12), io_key="F9"),
        key("F10", row=0, column=u(13), io_key="F10"),
        key("F11", row=0, column=u(14), io_key="F11"),
        key("F12", row=0, column=u(15), io_key="F12"),
        key(
            "Dwell",
            row=0,
            column=u(16),
